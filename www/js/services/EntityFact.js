    ...
    .factory('entityFactory', ['$http', '$q',  '$rootScope', '$log', 'myConfig', 'MemoryFactory', function($http, $q,  $rootScope, $log, myConfig, MemoryFactory) {
        ...
        return {
            ...
            getBBox: function(bbox,reset) {
                ...
                //query senza since
                bboxParamsString = bboxParamsString.concat( "&ne_lat=" + bbox.ne_lat + "&ne_lng=" + bbox.ne_lng + "&sw_lat=" + bbox.sw_lat + "&sw_lng=" + bbox.sw_lng + "&limit=6000").concat('&fields=valid_from,valid_to,parent_id,location,comment_of,article_of,group_of,categories,geometry,name');
                if(bbox.from)
